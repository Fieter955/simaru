...
<div>
    ...
    <div
        ...
        <div class="mb-3">
            ...
            <option value="<?php echo e($lab->id); ?>" data-te-select-secondary-text="kapasitas: <?php echo e($lab->capacity); ?>"><?php echo e($lab->name); ?></option>
            ...
            <div class="flex gap-x-5">
                ...
                <select data-te-select-init data-te-select-option-height="52" name="start_time">
                    ...
                    <?php $__currentLoopData = $timeMappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" data-te-select-secondary-text="<?php echo e($value[0]); ?> - <?php echo e($value[1]); ?>">
                    <?php echo e($key); ?>
...
</div><?php /**PATH C:\applications\simaru\resources\views/components/modal-booking.blade.php ENDPATH**/ ?>