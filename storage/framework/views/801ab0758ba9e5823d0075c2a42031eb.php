<div>
    ...
    wire:ignore.self
        ...
        <!--[if BLOCK]><![endif]--><?php if(session('conflict')): ?>
            <div
            ...
            <div class="">
                ...
                <div class="relative mb-3" data-te-input-wrapper-init>
                    ...
                    value="<?php echo e($user->name); ?> (<?php echo e($user->role); ?>)"
                    disabled />
                </div>
            </div>
            <div class="mb-3">
                <label for="lab_id">Pilih Lab<span class="text-red-500">*</span></label>
                <select name="lab_id" id="lab_id" wire:model="lab_id" class="w-full py-2 px-1 rounded-md border <?php $__errorArgs = ['lab_id'];
...
unset($__errorArgs, $__bag); ?>">
                ...
                <option value="<?php echo e($lab->id); ?>" class="py-4"><?php echo e($lab->name); ?> (<?php echo e($lab->capacity); ?>)</option>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3">
                ...
                <textarea
                    class="border <?php $__errorArgs = ['reason_to_booking'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> w-full p-2 rounded-md"
                    id="keperluan"
                    rows="3"
                    ...
                    <div class="text-red-600 -mt-1">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['reason_to_booking'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3">
                ...
                <div
                class="mb-3 relative border <?php $__errorArgs = ['booking_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> w-full rounded-md"
                ...
                <div class="text-red-600">
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['booking_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?><?php unset($message);
            ...
            <div class="mb-3">
                <div class="flex gap-x-5">
                    <div class="">
                        ...
                        <select id="jam_mulai" class="w-full py-2 border <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-md px-1" wire:model="start_time">
                            <option selected>pilih jam</option>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeMappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($letter); ?>">
                            <?php echo e($letter); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="">
                        ...
                        <select id="jam_selesai" class="w-full py-2 border <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-md px-1" wire:model="end_time">
                            <option selected>pilih jam</option>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeMappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($letter); ?>">
                            <?php echo e($letter); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\applications\simaru\resources\views/livewire/modal-booking.blade.php ENDPATH**/ ?>